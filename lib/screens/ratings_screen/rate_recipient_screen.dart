...
class RateRecipientScreen extends StatefulWidget {
  const RateRecipientScreen({
    Key? key,
  ...
  @override
  State<RateRecipientScreen> createState() => _RateRecipientScreenState();
}

class _RateRecipientScreenState extends State<RateRecipientScreen> {
